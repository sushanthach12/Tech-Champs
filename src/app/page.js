			...
			<div class="relative px-6 lg:px-8">
				<div class="relative  px-6 lg:px-8">
					<div class="relative px-6 lg:px-8">
						...
						<div class="mx-auto py-36 sm:py-30">
							...
							<div className="flex w-full justify-between items-center">
								<div class="text-center">
									<h1 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl">“The best way to predict the future is to create it.”</h1>
								...
								<div className="h-full">
									<img src="/office.png" className="h-full w-full"/>
								</div>
							</div>
