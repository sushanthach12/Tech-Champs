                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-3" method="POST" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <div className="mt-2">
                                <input id="username" name="username" type="text" required className="block w-full rounded-md border-0 py-1.5 ring-2 ring-gray-300 text-gray-900 shadow-sm  placeholder:text-gray-400 px-3 sm:text-sm sm:leading-6" value={credentials.username} onChange={handleChange} />
                            </div>
                        </div>
